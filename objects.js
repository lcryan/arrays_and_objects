// ===  Opdracht 1 ===
// Maak een object met daarin jouw voornaam (string), achternaam (string), leeftijd (getal) en geboortedatum (date object).
// De datum hoeft niet geformat te worden.
...
console.log("Hoi"+ " " + "Ik ben" + " " +dataMe.firstName + ","  + "ik ben" + " " + dataMe.age + " " + "jaar oud")
...
// 3b. Overschrijf de oude waarde van de property color ("creme") naar "roze".
// Log het object in de terminal om te checken of het gelukt is.
...
console.log("De" + " " + product.productName + " " + "is gemaakt van" + " " + product.material[0] + " " + "en" + " " +
    product.material[1])
